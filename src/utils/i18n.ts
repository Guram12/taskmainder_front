...
const resources = {
  en: {
    translation: {
      ...
      'user_info_update_text': 'Here you can update your username, phone number, and timezone.',
      'change_password': 'Change Password',
  ...
  ka: {
    translation: {
      ...
      'user_info_update_text': 'აქ შეგიძლიათ განაახლოთ თქვენი მომხმარებლის სახელი, ტელეფონის ნომერი და დროის სარტყელი.',
      'change_password': 'პაროლის შეცვლა',
