...
const Templates: React.FC<TemplatesProps> = ({ handleTemplateSelect, currentTheme, setIsLoading }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Templates | DailyDoer</title>
        <meta name="description" content="Browse and select ready-made board templates to quickly start organizing your tasks and projects on DailyDoer." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://dailydoer.space/mainpage/templates" />
      </Helmet>
