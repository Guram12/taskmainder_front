...
const GitHubSignIn: React.FC<GitHubSignInProps> = ({ }) => {
  const [github_loading, setGithub_loading] = useState<boolean>(false);


  const handleGitHubLogin = () => {
    setGithub_loading(true);
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.backgroundColor = '#1c2025';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      {github_loading ? <PulseLoader size={6} color="#ffffff" /> : 'Sign in with GitHub'}
    </button>
  );
};
